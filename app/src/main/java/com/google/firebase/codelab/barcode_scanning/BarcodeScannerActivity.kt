                ...
                .addOnSuccessListener {
                    ...
                    for (firebaseBarcode in it){
                        when (firebaseBarcode.valueType){
                            ...
                            //Handle the contact info here, address, phone, name
                            FirebaseVisionBarcode.TYPE_CONTACT_INFO ->
                                qrList.add(QrCode("Contact", firebaseBarcode.contactInfo?.title))

                            //Handle the wifi here, firebaseBarcode.wifi.ssid etc
                            FirebaseVisionBarcode.TYPE_WIFI ->
                                qrList.add(QrCode("WiFi", firebaseBarcode.wifi?.ssid))

                            //Handle the driver license barcode here, CITY, Name, Expiry
